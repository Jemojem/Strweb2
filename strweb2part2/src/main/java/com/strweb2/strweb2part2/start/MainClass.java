package com.strweb2.strweb2part2.start;

import com.strweb2.strweb2part2.action.StudentAction;
import com.strweb2.strweb2part2.model.Student;
...
public class MainClass {
    ...
    public void addStudent (boolean a)
    {
    	Student student = new Student();
    	student.setFname("Amogus");
    	student.setLname("Vitenko");
    	student.setDob(Date.valueOf("2001-01-29"));
    	action.insert(student);
    }
